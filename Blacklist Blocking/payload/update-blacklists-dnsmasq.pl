...
my $ad_list_url    = "http://pgl.yoyo.org/adservers/serverlist.php?hostformat=dnsmasq&showintro=0&mimetype=plaintext";
...
# print get_blacklist;
write_list( $blacklist_file, get_blacklist() ) && system ("$dnsmasq force-reload");
