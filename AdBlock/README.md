...
* upload install_adblock.v3.22rc1.tgz to your router (e.g. scp <local path>/install_adblock.v3.22rc1.tgz <user>@<erl router>:/tmp/install_adblock.v3.22rc1.tgz)
    - sudo tar zxvf ./install_adblock.v3.22rc1.tgz
...
CLI commands to configure the ADBlock Blacklist:
    ...
    set service dns forwarding blacklist source hpHosts description 'hpHosts optimized in hosts format'
    set service dns forwarding blacklist source hpHosts prefix 127.0.0.1
    set service dns forwarding blacklist source hpHosts url 'http://hosts-file.net/download/HOSTS-Optimized.txt'
    set service dns forwarding blacklist source malc0de.com description 'List of domains serving malicious executables observed by malc0de.com/database/'
    set service dns forwarding blacklist source malc0de.com prefix zone
    set service dns forwarding blacklist source malc0de.com url 'http://malc0de.com/bl/ZONES'
    ...
    set service dns forwarding blacklist source volkerschatz.com description 'Ad server blacklists'
    set service dns forwarding blacklist source volkerschatz.com prefix 'htt.*/'
    set service dns forwarding blacklist source volkerschatz.com url 'http://www.volkerschatz.com/net/adpaths'
